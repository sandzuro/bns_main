...
if(document.addEventListener ){ 
   ...
   aLoader = [
      ...
      { load: "1.1.2/js/max/EdgeCommons.Parallax.js", user: true },
      { load: "1.1.2/js/max/EdgeCommons.js", user: true },
      { load: "1.1.2/js/max/EdgeCommons.Core.js", user: true },
      { load: "bns_parallax_02_edge.js"},
      { load: "bns_parallax_02_edgeActions.js"}];
...
var plSTF="none",ctrPlS="horizontal",minPlW="0",maxPlW=undefined,plWidth="100%",plHeight="3000px";
